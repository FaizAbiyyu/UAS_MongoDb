        ...
        <div class="header">    
            <div class="header-content clearfix">
               ...
               <div class="text-center">
                <h2 class="pt-3"> Berita Indonesia </h2>
                 </div>
                ...
                <ul class="metismenu" id="menu">
                   <br> <br>       
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-pencil-square-o menu-icon"></i><span class="nav-text">Berita</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./add_berita.php"> <i class="icon-plus menu-icon"></i>Tambah Berita</a></li>
                            <li><a href="./show_berita.php"><i class="fa fa-cog menu-icon"></i>Lihat Berita</a></li>
                        </ul>
                    </li>
